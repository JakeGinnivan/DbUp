...
/// <summary>
/// Configuration extension methods for SQLite.Mono (see http://www.sqlite.org/)
/// </summary>
...
public static class SQLiteMonoExtensions
// ReSharper restore CheckNamespace
{
    ...
    /// </returns>
    public static UpgradeEngineBuilder SQLiteMonoDatabase(this SupportedDatabases supported, string connectionString)
    {
    ...
    /// A builder for a database upgrader designed for SQLite databases.
    /// </returns>
    public static UpgradeEngineBuilder SQLiteMonoDatabase(this SupportedDatabases supported, SharedConnection sharedConnection)
    {
        var builder = new UpgradeEngineBuilder();
